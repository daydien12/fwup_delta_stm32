...
int16_t FrameMessage::CreateMessage(uint8_t type_msg, uint16_t length, uint8_t *datain, uint8_t *dataout)
{
...
int16_t FrameMessage::DetectMessage(uint8_t *datain, messageFrameMsg_t *dataout)
{
	uint16_t count_length_arr = 0;
